...
- User (if user is not DEFAULT_USER, which can then be set in your profile)
- Git status
...
![Screenshot](https://github.com/MashhadiNima/agnoster-zsh-theme/raw/master/screenshot_1.png)

![Screenshot](https://github.com/MashhadiNima/agnoster-zsh-theme/raw/master/screenshot_2.png)
